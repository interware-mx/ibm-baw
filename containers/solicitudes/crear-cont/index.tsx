...
// 🌐 Context
import { useSolicitudCreateContext } from "@/context/solicitudes/solicitud-create-context";
...
const CrearCont = () => {
  ...
  const { formikVariables, cancelAction, isDisabled } =
    useSolicitudCreateContext();
  ...
  return (
    <>
      <div className="border p-4">
        ...
        <FormaSolicitud formikVariables={formikVariables} />
      </div>
